...
export const pieceDefinitions = [
  definePiece({
    ...
    flipAxis: { start: { x: 1.75, y: 1.6 }, end: { x: 1.75, y: 4.15 } },
  }),
  definePiece({
    id: "green-wing",
    name: "Skrzydlo srodkowe",
    workColor: "green",
    vertices: [
      { x: 1.75, y: 0 },
      { x: 3.25, y: 0 },
    ...
    flipAxis: { start: { x: 1.25, y: 1 }, end: { x: 3.25, y: 0 } },
  }),
  definePiece({
    id: "pink-keystone",
    name: "Lewy skos belki",
    workColor: "pink",
    vertices: [
      { x: 0, y: 0 },
      { x: 1.75, y: 0 },
    ...
    flipAxis: { start: { x: 0, y: 0.5 }, end: { x: 1.25, y: 0.5 } },
  }),
  definePiece({
    id: "yellow-cap",
    name: "Prawy skos belki",
    workColor: "yellow",
    vertices: [
      { x: 3.25, y: 0 },
      { x: 3.75, y: 0 },
    ...
    flipAxis: { start: { x: 2.8, y: 0.5 }, end: { x: 3.75, y: 0.5 } },
  }),

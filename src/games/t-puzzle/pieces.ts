...
export const pieceDefinitions = [
  definePiece({
    ...
    flipAxis: { start: { x: 2, y: 1 }, end: { x: 2, y: 4 } },
  }),
  definePiece({
    id: "green-wing",
    name: "Skrzydło ukośne",
    workColor: "green",
    vertices: [
      { x: 0, y: 0 },
      { x: 2.2, y: 0 },
    ...
    flipAxis: { start: { x: 0.2, y: 0.5 }, end: { x: 1.9, y: 0.5 } },
  }),
  definePiece({
    id: "pink-keystone",
    name: "Zwornik",
    ...
    flipAxis: { start: { x: 2.3, y: 0.12 }, end: { x: 2.35, y: 0.95 } },
  }),
  definePiece({
    id: "yellow-cap",
    name: "Czapka prawa",
    ...
    flipAxis: { start: { x: 3.35, y: 0.5 }, end: { x: 4, y: 0.5 } },
  }),

...
export function createInitialPieceStates(): PieceState[] {
  return [
    ...
    },
    {
      ...
      zIndex: 2,
      groupId: "group-green",
      lastValidPosition: { x: 0.8, y: 0.4 },
    },
    {
      pieceId: "pink-keystone",
      position: { x: -2.9, y: 4.5 },
      rotation: 90,
      flipped: false,
      zIndex: 3,
      groupId: "group-red",
      lastValidPosition: { x: -2.9, y: 4.5 },
    },
    {
      pieceId: "yellow-cap",
      position: { x: 0.8, y: 4.7 },
      rotation: 270,
      flipped: false,
      zIndex: 4,
      groupId: "group-yellow",
      lastValidPosition: { x: 0.8, y: 4.7 },
    },
  ];
}
